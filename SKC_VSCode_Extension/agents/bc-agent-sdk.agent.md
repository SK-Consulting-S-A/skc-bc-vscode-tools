...
- Use **high-effort reasoning** for multi-object agent implementations, interface-binding decisions, and session/task execution flows.
- Use **medium-effort reasoning** for scoped updates to a single existing agent object or setup page.
